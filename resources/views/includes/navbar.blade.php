<div x-data="{openDropdown: false}" class="sticky top-0 z-40">
    <div class="w-full h-16 px-6 bg-gray-100 border-b flex items-center justify-between">
        ...
        <div class="flex items-center relative">
            ...
            <img @click="openDropdown = true" src="https://a7sas.net/wp-content/uploads/2019/07/4060.jpeg" class="w-12 h-12 rounded-full shadow-lg cursor-pointer">
        </div>

    </div>

    <!-- dropdown menu -->
    <div x-cloak x-show="openDropdown" @click.away="openDropdown = false" class="absolute bg-gray-100 border border-t-0 shadow-xl text-gray-700 rounded-b-lg w-48 right-0 mr-6">
        ...
        <form method="POST" class="hidden" id="logout-form" action="{{ route('logout') }}">
            @csrf
        </form>
    </div>
    <!-- dropdown menu end -->
